  ...
  return (
    <div>
      <div className="bg-[#0E6248] text-white pt-8 pb-6 px-4 md:pt-15 md:pb-10 md:px-20 flex flex-col md:flex-row w-full justify-between items-center md:items-start text-center md:text-left">
        <div className="flex flex-col items-center md:items-start w-full md:w-1/2 gap-3 mb-8 md:mb-0 md:gap-5">
          <div className="flex items-center gap-3 md:gap-5">
            <img src="/logo.svg" alt="Desa Wonorejo Logo" className="h-10 w-10 md:h-auto md:w-auto"></img>
          ...
          <p className="text-sm md:text-[16px] w-full px-2 md:w-2/3 pt-2 md:pt-4">
        ...
        <div className="flex flex-col items-center md:items-start w-full md:w-auto gap-3">
          <h1 className="font-bold pb-3 md:pb-6 text-lg md:text-[20px]">Hubungi Kami</h1>
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm md:text-base">pemerintah.wonorejo@yahoo.com</p>
          </div>
        </div>
      </div>
